<template>
    <modMain :title="$t('dw.t81')" class="bill-main setting">
        ...
        <div class="bill">
            <van-pull-refresh v-model="isDownLoading" @refresh="onDownRefresh" :pullingText="pullingText"
                              :loosingText="loosingText" :loadingText="loadingText">
                <van-list v-if="list && list.length > 0" v-model="isUpLoading" :finished="upFinished"
                          :finished-text="$t('sys.nomore')" :immediate-check="false" offset="20"
