export default {
  ...
  msg: {
    ...
    invalidVerifyCode: 'Phone verify code invalid!',
    ...
    sendVerifyRequest: 'Please click phone verify button and receive the verify code',
  ...
  home: {
    ...
    phoneVerifyCode: 'Please enter the verify code',
  ...
  transType:{
    ...
    Buy_Product_Balance: 'Buy Product Balance',
    Child_First_Purchase_Reward: 'Child First Purchase Reward',
    ...
    Treasure_Transfer_In: 'Treasure Transfer In',
    Treasure_Transfer_Out: 'Treasure Transfer Out',
  ...
  dw: {
    ...
    t194: 'Introduction about the Asset',
    t195: 'More',
    t196: 'Treasure',
