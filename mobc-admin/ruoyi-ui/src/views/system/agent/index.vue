    ...
    <el-row :gutter="20">
      <el-col>
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="账户" align="center" key="userName" v-if="columns[1].visible" >
          ...
          <el-table-column label="Email" align="center" key="email" prop="email"/>
          <el-table-column label="WhatsApp" align="center" key="whatsApp" prop="whatsApp"/>
          <el-table-column label="Telegram" align="center" key="telegram" prop="telegram"/>
          ...
          >
            <template slot-scope="scope">
             ...
             <!-- <el-button
              ...
              >删除</el-button>-->
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:agent:resetPwd', 'system:agent:edit']">
                <el-button size="mini" type="text" icon="el-icon-d-arrow-right">更多</el-button>
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleResetPwd" icon="el-icon-key"
                    v-hasPermi="['system:agent:resetPwd']">重置密码</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="代理商账号" prop="userName">
                <el-input size="mini" oninput = "value=value.replace(/[^\d]/g,'')" v-model=" form.userName" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="昵称" prop="nickName">
                <el-input size="mini"  v-model="form.nickName"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="手机号码" prop="phonenumber">
                <el-input size="mini" v-model=" form.phonenumber" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, resetUserPwd, changeUserStatus, } from "@/api/system/agent";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/agent/importData"
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
      ...
      rules: {
        userName: [
          ...
          { min: 5, max: 20, message: '账户长度必须介于 5 和 20 之间', trigger: 'blur' }
        ],
        nickName: [
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('system/agent/importTemplate', {
