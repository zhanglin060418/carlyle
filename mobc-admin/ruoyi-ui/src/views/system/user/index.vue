    ...
    <el-row :gutter="20">
      <el-col>
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="业务员账号" align="center" key="userName" v-if="columns[1].visible" >
  ...
  data() {
    return {
      ...
      rules: {
        ...
        whatsApp: [
          { required: true, message: "WhatsApp不能为空", trigger: "blur" }
        ],
        telegram: [
          { required: true, message: "Telegram不能为空", trigger: "blur" }
        ],
        password: [
